Code corresponding to task 6 are in `main.py`. As 1Tb file is to big to be read fully. `main` function has parameter that sets up the max number of lines to read.
